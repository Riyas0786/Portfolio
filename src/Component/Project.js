...
>
  <Carousel interval={2500} controls indicators>
              <Carousel.Item>
                <img src={projectimg} alt="Home Page" className="d-block  img-fluid  rounded-3 mx-auto " style={{width:'600px'}} />
              ...
              <Carousel.Item>
                <img src={menuimg} alt="Menu Page" className="d-block  img-fluid rounded-3 mx-auto" style={{width:'600px'}} />
                <div className="carousel-text text-center mt-2">
              ...
              <Carousel.Item>
                <img src={accountimg} alt="Account Page" className="d-block  img-fluid rounded-3 mx-auto" style={{width:'600px'}}/>
                <div className="carousel-text text-center mt-2">
              ...
              <Carousel.Item>
                <img src={cartimg} alt="Cart Page" className="d-block  img-fluid rounded-3 mx-auto"style={{width:'600px'}} />
                <div className="carousel-text text-center mt-2">
